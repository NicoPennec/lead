<template>
  <div>
    ...
    <projecthero
      pDate="Aug 2018 "
      pWebsite="concityre.com"
      pCategory="eCommerce Design and Development"
      pHeading="conciTyre Marketplace"
      pHeadingcolor="color:#d60100;"
      pSubheading="conciTyre is Bermuda based marketplace for buy and sell tyres."
    />
      ...
      <div class="projects-footer-container">
        ...
        <div class="p-f-p-container">
          <nuxt-link to="/projects/toko">
            <pfooterp
              projectName="Toko"
              projectCategories="Mobile App and Blockchain Development"
        ...
        <div class="p-f-n-container">
          <nuxt-link to="/projects/avataremoji">
            <pfootern
              projectName="Avatar Emoji"
              projectCategories="Design and Illustration"
